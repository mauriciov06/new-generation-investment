                    ...
                    <div class="md-float-material form-material">
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                {!!Form::open(['route'=>'recuperar-contrasena.store', 'method'=>'POST','files'=>true])!!}
                                  <div class="form-group form-primary">
                                      {!!Form::email('email', null,['class'=>'form-control', 'placeholder'=>'Correo electrónico'])!!}
                                  </div>
                                  <div class="row">
                                      <div class="col-md-12">
                                          {!!Form::submit('Recuperar',['class'=>'btn btn-primary btn-md btn-block waves-effect text-center m-b-20'])!!}
                                      </div>
                                  </div>
                                {!!Form::close()!!}
