...
<div class="col-xl-6 col-sm-6">
	<div class="form-group">
		...
		{!!Form::select('tipo_documento',[null => 'Seleccionar'] + ['CC' => 'Cedula de ciudadania','CE'=>'Cedula Extranjería','PA'=>'Pasaporte','RC'=>'Registro Civil','RC'=>'Registro Civil'], null,['class'=>'form-control'])!!}
	</div>
</div>
<div class="col-xl-6 col-sm-6">
	<div class="form-group">
